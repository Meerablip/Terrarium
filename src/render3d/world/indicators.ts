...
// apps/desktop/src/plugins/builtin/voxel_graph/world/indicators.ts
//
// Not wired into engine.ts until Phase 3 (selection ring) — ported now
// while the source is on hand, alongside the other near-verbatim files.
//
